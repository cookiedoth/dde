...
def get_2d_sincos_pos_embed(embed_dim, grid_size, cls_token=False, extra_tokens=0, shift=(0, 0)):
    ...
    """
    grid_h = np.arange(shift[0], shift[0] + grid_size, dtype=np.float32)
    grid_w = np.arange(shift[1], shift[1] + grid_size, dtype=np.float32)
...
if __name__ == '__main__':
    pos_enc = get_2d_sincos_pos_embed(embed_dim=24, grid_size=5)
    np_stats(pos_enc)
